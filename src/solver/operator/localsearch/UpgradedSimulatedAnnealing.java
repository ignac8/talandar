...
public class UpgradedSimulatedAnnealing extends LocalSearch {
    ...
    public UpgradedSimulatedAnnealing(int neighbourSize, Solver solver, SingleMutation singleMutation, double decTemp, double modifier, int populationSize) {
